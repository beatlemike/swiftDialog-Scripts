...
#   Version 1.0.2, 08.07.2023, Mike Fredette (@beatlemike)
#	- Added Launch Daemon.
#
####################################################################################################
...
deferralName="${11:-"deferral"}"             											    # Parameter 11: Deferral Name [This will be used by the Launch Daemon file for it's name as well as the deferral trigger name (i.e. rumdeferral)]
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# Remove any previous Launch Daemon
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

if [[ -f $plist_path ]]; then
    launchctl unload -F $plist_path
    rm $plist_path
fi
...
# Create the Launch Daemon .plist content
cat > $plist_path <<EOF
...
<dict>
  <key>Label</key>
  <string>com.beatlemike.$deferralName</string>
  <key>ProgramArguments</key>
  <array>
    <string>/bin/zsh</string>
    <string>-c</string>
    <string>/usr/local/jamf/bin/jamf policy -trigger $deferralName</string>
  </array>
...
launchctl start com.beatlemike.$deferralName

    echo "Launch Daemon created and loaded to run on $deferralDateReadable."
